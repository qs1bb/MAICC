...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.base_reward = self.max_reward
    ...
    def reset(self, episode_config={}):
        ...
        self.max_reward = self.base_reward
        if self.debug:
            logging.debug(
    ...
    def get_obs_agent(self, agent_id, fully_observable=False):
        ...
        if (
                ...
                if (enemy_visible and e_unit.health > 0) or (
                    ...
                    if self.unit_type_bits > 0 and show_enemy:
                        ...
                        if self._agent_race == "P":
                            enemy_feats[e_id, ind + type_id] = 1 / 3
                        elif self._agent_race == "T":
                            enemy_feats[e_id, ind + type_id] = 2 / 3
                        elif self._agent_race == "Z":
            ...
            for i, al_id in enumerate(al_ids):
                ...
                if (ally_visible and al_unit.health > 0) or (
                    ...
                    if self.unit_type_bits > 0 and (
                        ...
                        if self._agent_race == "P":
                            ally_feats[i, ind + type_id] = 1 / 3
                        elif self._agent_race == "T":
                            ally_feats[i, ind + type_id] = 2 / 3
                        elif self._agent_race == "Z":
            ...
            if self.unit_type_bits > 0:
                ...
                if self._agent_race == "P":
                    own_feats[ind + type_id] = 1 / 3
                elif self._agent_race == "T":
                    own_feats[ind + type_id] = 2 / 3
                elif self._agent_race == "Z":
    ...
    def get_env_info(self):
        ...
        env_info["races"] = self._agent_race
